package thearknoah05.missy.client.models.entity.passive;// Made with Blockbench 3.6.6
...
public class TemporalBatModel extends EntityModel<TemporalBatEntity> {
	...
	@Override
	public void render(TemporalBatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
	...
	public void setRotationAngles(TemporalBatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
